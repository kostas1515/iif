...
data = dict(
    ...
    workers_per_gpu=4,
        ...
        dataset=dict(
            type='LVISV05Dataset',
            ann_file='../../../../object_detection/datasets/coco/annotations/lvis_v0.5_train.json',
            img_prefix='../../../../object_detection/datasets/coco/train2017/',
            pipeline=[
                dict(type='LoadImageFromFile'),
                dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
                dict(
    ...
    val=dict(
        type='LVISV05Dataset',
        ann_file='../../../../object_detection/datasets/coco/annotations/lvis_v0.5_val.json',
        img_prefix='../../../../object_detection/datasets/coco/val2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
